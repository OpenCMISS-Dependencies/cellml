...
MODULE CELLML_MODEL_DEFINITION
  ...
  INTERFACE
     ...
     SUBROUTINE CELLML_MODEL_DEFINITION_SET_VARIABLE_AS_KNOWN (MODEL,NAME) &
          BIND(C,NAME='cellml_model_definition_set_variable_as_known_f')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_PTR
       TYPE (C_PTR), VALUE :: MODEL
       CHARACTER, DIMENSION(*) :: NAME
     END SUBROUTINE CELLML_MODEL_DEFINITION_SET_VARIABLE_AS_KNOWN
     SUBROUTINE CELLML_MODEL_DEFINITION_SET_VARIABLE_AS_WANTED (MODEL,NAME) &
          BIND(C,NAME='cellml_model_definition_set_variable_as_wanted_f')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_PTR
       TYPE (C_PTR), VALUE :: MODEL
       CHARACTER, DIMENSION(*) :: NAME
     END SUBROUTINE CELLML_MODEL_DEFINITION_SET_VARIABLE_AS_WANTED
