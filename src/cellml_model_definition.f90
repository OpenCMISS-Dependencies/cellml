...
MODULE CELLML_MODEL_DEFINITION
  ...
  INTERFACE
     ...
     INTEGER (C_INT) FUNCTION CELLML_MODEL_DEFINITION_ADD_MAPPING_TO_FIELD (MODEL,NAME) &
          BIND(C,NAME='cellml_model_definition_add_mapping_to_field_f')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_PTR,C_INT
       TYPE (C_PTR), VALUE :: MODEL
       CHARACTER, DIMENSION(*) :: NAME
     END FUNCTION CELLML_MODEL_DEFINITION_ADD_MAPPING_TO_FIELD
